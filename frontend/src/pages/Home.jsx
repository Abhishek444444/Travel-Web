          ...
          <Row className="align-items-center">
            <Col lg="6">
              <div className="hero_content">
                ...
                <p>
                  Discover new places, meet amazing people, and create unforgettable adventures. Every journey is a chance to learn, grow, and make memories that last a lifetime.
                </p>
              </div>
            </Col>
          ...
          <Row className="align-items-center">
            <Col lg="6">
              <div className="experience_content">
                ...
                <p>
                  Our team is passionate about travel and dedicated to making your trips extraordinary. From planning to exploring, we ensure every moment is filled with excitement and comfort.
                  <br />
                  Let us guide you to the world's most beautiful destinations and experiences.
                </p>
              </div>
